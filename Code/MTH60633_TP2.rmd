...
f_plot_pdf(result_uni$PL, title, x_lim)
f_png_save(result_uni$PL, title, x_lim, file_name)
```
...
f_plot_pdf(result_bi$PL, title, x_lim)
f_png_save(result_bi$PL, title, x_lim, file_name)
```
...
f_plot_pdf(result_cop$PL, title, x_lim)
f_png_save(result_cop$PL, title, x_lim, file_name)
```
...
f_plot_pdf(result_compl$PL, title, x_lim)
f_png_save(result_compl$PL, title, x_lim, file_name)
```
